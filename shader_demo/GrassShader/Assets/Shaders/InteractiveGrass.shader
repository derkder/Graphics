Shader "Custom/Interactive Grass"
{
    Properties
    {
    ...
    void geo(triangle vertexOutput IN[3], inout TriangleStream<geometryOutput> triStream)
    {
        ...
        float2 rtUV = worldPos.xz - _CamPos.xz;
        rtUV = rtUV / (_OrthographicCamSize * 2);
        rtUV += 0.5;

        float4 clr = tex2Dlod(_EffectRT, float4(rtUV, 0, 0));
        if (clr.b == 1 && clr.a == 1) return;
